...
class MotionStudioWindow(QMainWindow):
    def __init__(
        ...
        library_tabs.setObjectName("libraryTabs")
        library_tabs.addTab(self.gesture_widget, "Gestures")
        library_tabs.addTab(self.pose_widget, "Poses")
        workspace_splitter = QSplitter(Qt.Horizontal)
        workspace_splitter.setObjectName("workspaceSplitter")
        workspace_splitter.addWidget(library_tabs)
        workspace_splitter.addWidget(self.keyframe_widget)
